...
const Skills = () => {
  return (
    <Section id="skills" title="Skills">
      {/* Use flex-row on large screens and flex-wrap to handle multiple rows */}
      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-8 items-center">
