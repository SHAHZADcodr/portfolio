...
import myImage from '../assets/shady.jpg'; // Make sure the image path is correct and the file exists
          ...
          <Card className="image-card">
            <div className="card-inner">
              <div className="card-front">
                <Card.Img variant="top" src={myImage} alt="Shahzad" className="profile-image" />
              </div>
