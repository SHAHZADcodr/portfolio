...
const Skills = () => {
  return (
    <Section id="skills" title="Skills">
      {/* Ensuring flex direction switches between row and column based on screen size */}
      <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-8 items-center">
